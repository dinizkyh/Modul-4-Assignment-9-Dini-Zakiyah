...
var validations = {
  ...
  creationStack(store) {
    ...
    if (stack == null ? void 0 : stack.includes("Layer.handle [as handle_request]")) {
      if (!store.localKeys) {
        throw new ValidationError(
...
var parseOptions = (passedOptions) => {
  ...
  const validations2 = getValidations((notUndefinedOptions == null ? void 0 : notUndefinedOptions.validate) ?? true);
